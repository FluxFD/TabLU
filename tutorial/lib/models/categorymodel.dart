  ...
  Future<List<dynamic>> fetchPageantEvents() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'http://192.168.101.6:8080/pageant-events'), // Replace with your API URL
        headers: {
    ...
    if (confirmDelete == true) {
      try {
        ...
        final response = await http
            .delete(Uri.parse('http://192.168.101.6:8080/event/$eventId'));
...
class _TalentShowsScreenState extends State<TalentShowsScreen> {
  ...
  Future<List<dynamic>> fetchTalentEvents() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'http://192.168.101.6:8080/talent-events'), // Replace with your API URL
        headers: {
          'Authorization': 'Bearer $token', // Using the token in the header
        },
      );
...
class _DebatesScreenState extends State<DebatesScreen> {
  ...
  Future<List<dynamic>> fetchDebateEvents() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'http://192.168.101.6:8080/debate-events'), // Replace with your API URL
        headers: {
          'Authorization': 'Bearer $token', // Using the token in the header
        },
      );
...
class _ArtContestScreenState extends State<ArtContestScreen> {
  ...
  Future<List<dynamic>> fetchArtContestEvents() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'http://192.168.101.6:8080/artcontest-events'), // Replace with your API URL
        headers: {
          'Authorization': 'Bearer $token', // Using the token in the header
        },
      );
