  ...
  Future<List<dynamic>> fetchPageantEvents() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'https://tabluprod.onrender.com/pageant-events'), // Replace with your API URL
        headers: {
    ...
    if (confirmDelete == true) {
      try {
        ...
        final response = await http
            .delete(Uri.parse('https://tabluprod.onrender.com/event/$eventId'));
...
class _TalentShowsScreenState extends State<TalentShowsScreen> {
  ...
  Future<List<dynamic>> fetchTalentEvents() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'https://tabluprod.onrender.com/talent-events'), // Replace with your API URL
        headers: {
          'Authorization': 'Bearer $token', // Using the token in the header
        },
      );
...
class _DebatesScreenState extends State<DebatesScreen> {
  ...
  Future<List<dynamic>> fetchDebateEvents() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'https://tabluprod.onrender.com/debate-events'), // Replace with your API URL
        headers: {
          'Authorization': 'Bearer $token', // Using the token in the header
        },
      );
...
class _ArtContestScreenState extends State<ArtContestScreen> {
  ...
  Future<List<dynamic>> fetchArtContestEvents() async {
    try {
      ...
      final response = await http.get(
        Uri.parse(
            'https://tabluprod.onrender.com/artcontest-events'), // Replace with your API URL
        headers: {
          'Authorization': 'Bearer $token', // Using the token in the header
        },
      );
